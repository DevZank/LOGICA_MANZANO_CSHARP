/*
  ...
  grãos (tendo-se então 15 grãos) até atingir o sexagésimo quarto (64o) quadro. Utilize variáveis 
  do tipo real como acumuladores. 
*/
...
class ExercicioD
{
    ...
    {
        double numeroDeVerificacao = 1;
        double dobro = 1;
        double quadro = 1;

        do
        {
            numeroDeVerificacao *= dobro;
            dobro *= 2;
            quadro++;
        ...
        Console.WriteLine($"A soma total foi: {dobro}");
    }
}